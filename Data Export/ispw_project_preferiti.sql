...
CREATE TABLE `preferiti` (
  ...
  KEY `fk_annuncio_idx` (`id_annuncio`),
  KEY `fk_venditore_idx` (`id_venditore`),
  CONSTRAINT `fk1_venditore` FOREIGN KEY (`id_venditore`) REFERENCES `venditore` (`id`),
  CONSTRAINT `fk_annuncio` FOREIGN KEY (`id_annuncio`) REFERENCES `annuncio` (`id`)
